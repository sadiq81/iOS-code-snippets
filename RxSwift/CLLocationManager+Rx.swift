...
extension Reactive where Base: CLLocationManager {
    ...
    */
    public var computedDelegate: DelegateProxy {
    ...
    */
    public var didUpdateLocations: Observable<[CLLocation]> {
        return computedDelegate.methodInvoked(#selector(CLLocationManagerDelegate
    ...
    */
    public var didFailWithError: Observable<NSError> {
        return computedDelegate.methodInvoked(#selector(CLLocationManagerDelegate.locationManager(_:didFailWithError:)))
                .map { a in
    ...
    */
    public var didUpdateHeading: Observable<CLHeading> {
        return computedDelegate.methodInvoked(#selector(CLLocationManagerDelegate.locationManager(_:didUpdateHeading:)))
                .map { a in
    ...
    */
    public var didEnterRegion: Observable<CLRegion> {
        return computedDelegate.methodInvoked(#selector(CLLocationManagerDelegate.locationManager(_:didEnterRegion:)))
                .map { a in
    ...
    */
    public var didExitRegion: Observable<CLRegion> {
        return computedDelegate.methodInvoked(#selector(CLLocationManagerDelegate.locationManager(_:didExitRegion:)))
                .map { a in
                    return try castOrThrow(CLRegion.self, a[1])
                }
    }
    ...
    */
    ...
    public var didVisit: Observable<CLVisit> {
        return computedDelegate.methodInvoked(#selector(CLLocationManagerDelegate.locationManager(_:didVisit:)))
                .map { a in
